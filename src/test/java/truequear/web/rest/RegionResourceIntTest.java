...
import truequear.domain.Region;
import truequear.repository.RegionRepository;
import truequear.repository.search.RegionSearchRepository;
import truequear.service.RegionService;
import truequear.service.dto.RegionDTO;
import truequear.service.mapper.RegionMapper;
...
public class RegionResourceIntTest {
    ...
    private static final String DEFAULT_NOMBRE_REGION = "AAAAAAAAAA";
    private static final String UPDATED_NOMBRE_REGION = "BBBBBBBBBB";
     ...
     *
     * @see truequear.repository.search.RegionSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Region createEntity(EntityManager em) {
        Region region = new Region()
            .nombreRegion(DEFAULT_NOMBRE_REGION);
        return region;
    }
    ...
    public void createRegion() throws Exception {
        ...
        assertThat(testRegion.getNombreRegion()).isEqualTo(DEFAULT_NOMBRE_REGION);
    ...
    @Test
    @Transactional
    public void checkNombreRegionIsRequired() throws Exception {
        int databaseSizeBeforeTest = regionRepository.findAll().size();
        // set the field null
        region.setNombreRegion(null);
    ...
    public void getAllRegions() throws Exception {
        ...
        restRegionMockMvc.perform(get("/api/regions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].nombreRegion").value(hasItem(DEFAULT_NOMBRE_REGION.toString())));
    }
    ...
    public void getRegion() throws Exception {
        ...
        restRegionMockMvc.perform(get("/api/regions/{id}", region.getId()))
            ...
            .andExpect(jsonPath("$.nombreRegion").value(DEFAULT_NOMBRE_REGION.toString()));
    }
    ...
    public void updateRegion() throws Exception {
        ...
        updatedRegion
            .nombreRegion(UPDATED_NOMBRE_REGION);
        ...
        Region testRegion = regionList.get(regionList.size() - 1);
        assertThat(testRegion.getNombreRegion()).isEqualTo(UPDATED_NOMBRE_REGION);
    ...
    public void searchRegion() throws Exception {
        ...
        restRegionMockMvc.perform(get("/api/_search/regions?query=id:" + region.getId()))
            ...
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(region.getId().intValue())))
            .andExpect(jsonPath("$.[*].nombreRegion").value(hasItem(DEFAULT_NOMBRE_REGION)));
    }
