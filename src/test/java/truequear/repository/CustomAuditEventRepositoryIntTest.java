...
import truequear.config.audit.AuditEventConverter;
import truequear.domain.PersistentAuditEvent;
...
import static truequear.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
