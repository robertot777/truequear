...
public class ValoracionResource {
    ...
    /**
     * SEARCH  /_search/valoracions?query=:query : search for the valoracion corresponding
     * to the query.
     *
     * @param query the query of the valoracion search
     * @return the result of the search
     */
    @GetMapping("/_search/valoracions")
    @Timed
    public List<ValoracionDTO> searchValoracions(@RequestParam String query) {
        log.debug("REST request to search Valoracions for query {}", query);
        return valoracionService.search(query);
    }
