...
public class OfertaResource {
    ...
    /**
     * SEARCH  /_search/ofertas?query=:query : search for the oferta corresponding
     * to the query.
     *
    ...
    @Timed
    public List<OfertaDTO> searchOfertas(@RequestParam String query) {
        log.debug("REST request to search Ofertas for query {}", query);
        return ofertaService.search(query);
    }
